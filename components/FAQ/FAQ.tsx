...
export function Faq({ isOverview = false }: Props) {
  return (
    <Container size="sm" className={classes.wrapper}>
      ...
      <Accordion variant="separated">
        ...
        <Accordion.Item className={classes.item} value="order-cancellation">
          ...
          <Accordion.Panel>
            Yes, If you have an account with us, once an order has not been
            confirmed, you can cancel your order or modify it. You can go to{" "}
            <b>My account {">"} My Orders</b> page to check the status of your
            order.
            <br />
            Note that once an order has been confirmed, we are unable to cancel
            or modify it. However, if you have any concerns or need assistance,
            please contact our customer service team, and we&apos;ll do our best
          ...
          <>
            ...
            <Accordion.Item className={classes.item} value="order-tracking">
              ...
              <Accordion.Panel>
                ...
                number to monitor the status of your shipment and estimated
                delivery date. You can go to{" "}
            ...
            <Accordion.Item className={classes.item} value="artwork-file-types">
              ...
              <Accordion.Panel>
                We accept various file formats, including PNG, PDF, EPS and AI.
                For best results, we recommend using high-resolution images or
                vector files to ensure the quality of your custom design.
              </Accordion.Panel>
            </Accordion.Item>
          </>
        )}
